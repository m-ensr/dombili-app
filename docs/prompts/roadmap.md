...
* Bu roadmap’i **MVP kırpımı**na çevirebiliriz
* Her faz için **task list** çıkarabiliriz
* Firestore şemasını roadmap’e birebir bağlayabiliriz
* “Şimdi neyi kodlamalıyım?” checklist yapabiliriz
